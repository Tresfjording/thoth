...
const OUTPUT_HTML_FILE = __DIR__ . '/arbeidskopi.html';
const LEGACY_JSON_FILE = __DIR__ . '/arbeidskopi.json';
...
$path = rtrim(dirname($_SERVER['SCRIPT_NAME']), '/') . '/arbeidskopi.html?v=' . time();
